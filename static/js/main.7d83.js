...
`,Mt=e=>{let t=e,i=t.offsetLeft;for(;t.offsetParent;)i+=t.offsetParent.offsetLeft,t=t.offsetParent;return i};class It extends a.a{constructor(...e){var t;return t=super(...e),this.onClick=(e=>{const{duration:t,onChange:i}=this.props;i((e.clientX-Mt(e.currentTarget))/e.currentTarget.offsetWidth*t)}),t}render({time:e,duration:t,song:i,children:n}){const o=`translateX(-${100-e/t*100}%)`;return Object(a.c)(gt,{onClick:this.onClick,image:i.waveform},Object(a.c)(ut,{style:{transform:o}}),Object(a.c)(dt,null,i.title),Object(a.c)(dt,null,i.user))}}const pt=({playlist:e})=>({song:e.currentSong,time:e.time,duration:e.duration});var jt=Object(n.b)(pt)(It),yt=i(49),Nt=i.n(yt),Lt=i(50),ht=i.n(Lt),bt=i(51),xt=i.n(bt),Dt=i(52),mt=i.n(Dt),Tt=i(53),At=i.n(Tt),Ot=i(54),Ct=i.n(Ot);const St=G["c"].div`
  display: flex;
  justify-content: center;
...
//# sourceMappingURL=main.7d83.js.map